...
element_s *Text::getComponent(string s, string group)
{
...
void Text::insertComponent(string s, string group, element_s *component)
{
...
map<string, element_s *> *Text::getComponents(string group)
{
  if (group == "G1") {
...
element_s *Text::getComponent(string s)
{
  element_s *res;
