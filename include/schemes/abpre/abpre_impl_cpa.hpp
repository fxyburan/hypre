...
class ABPRE_Impl : public ABPRE {
 private:
  element_s *decryptOri(Ciphertext *ciphertext, Key *secret_key, vector<string> *attributes);

  element_s *decryptRenc(Ciphertext *ciphertext, Key *secret_key, vector<string> *attributes);
