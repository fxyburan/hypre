...
multiway_tree *
policy_resolution::ThresholdExpressionToMultiwayTree(string threshold_expression, element_s *sample_element)
{
  ...
  for (signed long int i = 0; i < len; ++i) {
    ...
    if ('(' == ch) {
      ...
      multiway_tree_node *node = new multiway_tree_node(multiway_tree_node::GATE, s, threshold_value,
                                                        sample_element);
      s.assign("");
